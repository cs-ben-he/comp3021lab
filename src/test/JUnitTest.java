...
public class JUnitTest {
    ...
    {
		NoteBook nb = new NoteBook();
		nb.createTextNote("Note1", "a","b c d e");
		TextNote t =(TextNote)nb.getFolders().get(0).getNotes().get(0);
		Character c = t.countLetters();
		System.out.println(c);
		Character a ='a';
		assertEquals("The search results is not match", a, c);
    }
